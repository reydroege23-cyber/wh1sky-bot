...
GROUP_COMMANDS = [
    ...
    BotCommand("lock", "Lock chat messages"),
    BotCommand("unlock", "Unlock chat messages"),
    BotCommand("enough", "Permanently re-ban a user"),
    BotCommand("unenough", "Remove permanent re-ban"),
    BotCommand("requestsystem", "Toggle moderation requests"),
    BotCommand("requests", "View moderation requests"),
    BotCommand("requestinfo", "View one request"),
    BotCommand("approve", "Approve a request"),
    BotCommand("reject", "Reject a request"),
    BotCommand("cancelrequest", "Cancel a request"),
    ...
    BotCommand("testmode", "Toggle security test mode"),
    BotCommand("autopunish", "Toggle automatic punishments"),
    BotCommand("whyaction", "Explain last security action"),
    ...
    BotCommand("aireplies", "Toggle Marine AI replies"),
    BotCommand("aimode", "Set Marine AI mode"),
    BotCommand("aicooldown", "Set Marine AI cooldown"),
